...
vim.api.nvim_set_keymap(
	"n",
	"<Leader>tv",
	"<Cmd>lua _G.toggle_vertical_term()<CR>",
	{ desc = "Terminal toggle vertical", noremap = true, silent = true }
)
vim.api.nvim_set_keymap(
	"n",
	"<Leader>th",
	"<Cmd>lua _G.toggle_horizontal_term()<CR>",
	{ desc = "Terminal toggle horizontal", noremap = true, silent = true }
)
vim.api.nvim_set_keymap(
	"n",
	"<Leader>tf",
	"<Cmd>lua _G.toggle_float_term()<CR>",
	{ desc = "Terminal toggle float", noremap = true, silent = true }
)
